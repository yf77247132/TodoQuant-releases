...
import { Wallet, FilePlus2, Edit3, Trash2, XCircle, ArrowLeftRight, Cpu, Key, Activity, LineChart, Settings, MessageCircle, ArrowLeft, ArrowRight, RefreshCcw } from 'lucide-react';
    ...
    <ErrorBoundary onError={handleError}>
      ...
      <aside className={`border-r border-border-default px-2 pt-2 pb-4 flex flex-col shrink-0 h-full transition-all duration-300 ${isSidebarCollapsed ? 'w-[65px]' : 'w-[180px]'} group`}>
        ...
        <nav className="flex-1 space-y-1 overflow-y-auto hidden-scrollbar">
          <NavItem id="market" icon={LineChart} label={t('nav.market')} activeModule={activeModule} onClick={handleSetActiveModule} isCollapsed={isSidebarCollapsed} />
