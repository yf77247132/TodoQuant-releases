...
export default function App() {
  ...
  const loadHistoryData = useCallback(async (targetIdx?: number | null) => {
      ...
      for (const acc of accounts) {
        ...
        if (exchange === 'OKX') {
          ...
          if (posData.ok) {
            ...
            if (Array.isArray(posData.data)) allPositions.push(...(posData.data as HistoryPosition[]));
          } else {
            anyStale = true;
          }
        }
    ...
    if (onlyIdx != null) {
      ...
      setHistoryPositions(prev => [...prev.filter((p) => (p as HistoryPosition)?._account !== onlyIdx), ...allPositions].sort((a, b) => {
      ...
      setHistoryPositions(allPositions);
    }
    } finally {
