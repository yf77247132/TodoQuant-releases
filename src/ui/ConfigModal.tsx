...
export default function ConfigModal({
  ...
  return createPortal(
    ...
    >
      ...
      <div className={`relative w-full bg-surface-2 border border-border-default rounded-2xl shadow-2xl shadow-black/50 overflow-hidden animate-in fade-in zoom-in-95 duration-200 ${preview ? 'max-w-2xl' : 'max-w-md'}`}>
