...
export const ORDER_TYPE_DISPLAY_MAP: Record<string, string> = {
...
export const isRegularOrder = (t: string) => ['market', 'limit', 'post_only', 'fok', 'ioc'].includes(t);
export const isTrigger = (t: string) => t === 'trigger';
export const isConditional = (t: string) => t === 'conditional';
export const isOCO = (t: string) => t === 'oco';
export const isChase = (t: string) => t === 'chase';
export const isMoveOrderStop = (t: string) => t === 'move_order_stop';
