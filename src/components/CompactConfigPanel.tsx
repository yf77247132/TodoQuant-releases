...
import type { ConditionTemplate, Order, Position } from '../types/index.ts';
...
import { computeTodayStats, type TodayStatsData } from '../lib/todayStats.ts';
...
import { buildPlaceDescSegments, buildAmendDescSegments, buildCancelDescSegments, buildCloseDescSegments, buildMarginDescSegments } from '../lib/configDesc.ts';
...
export default function CompactConfigPanel({
  ...
  const stats = useMemo(() => computeTodayStats(historyPositions, historyOrders, ordList, posList),
    [historyPositions, historyOrders, ordList, posList]);

  return (
    <div className="relative flex h-full w-full">
      <div className="flex flex-col h-full w-full bg-surface-2 rounded-2xl border border-border-default overflow-hidden">
