...
import { Settings, X, List, Trash2, AlertTriangle, ArrowUpToLine, LineChart, Pencil, Check } from 'lucide-react';
...
import { consumePendingTvSymbol } from '../lib/tvSymbolRequest.ts';
