...
export default function BacktestReportArea({
  ...
  if (phase === 'detecting') {
    return <Spinner size="lg" label={t('backtest.detecting')} showProgress />;
  }

  if (phase === 'downloading') {
    return <Spinner size="lg" label={t('backtest.downloading')} showProgress />;
  }

  if (phase === 'running') {
    return <Spinner size="lg" label={t('backtest.running')} showProgress />;
  }
