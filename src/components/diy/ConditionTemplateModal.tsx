                ...
                conditions.map((condition, idx) => (
                  <div key={condition.id} className="p-4 rounded-2xl bg-surface-1 border border-border-default shadow-sm space-y-4 relative group">
                    ...
                    <div className="pl-9 grid grid-cols-1 gap-4 border-l-2 border-border-subtle">
                      ...
                      {condition.type !== 'balance_less' && condition.type !== 'pos_count' && condition.type !== 'pos_sz_limit' && condition.type !== 'pos_pnl_amount' && condition.type !== 'pos_pnl_rate' && condition.type !== 'pos_margin' && condition.type !== 'pos_mgn_ratio_val' && condition.type !== 'pos_liq_dist' && condition.type !== 'pos_funding_rate' && condition.type !== 'time_window' && condition.type !== 'cooldown' && condition.type !== 'count_limit' && condition.type !== 'pos_side' && condition.type !== 'tv_signal' && condition.type !== 'indicator' && (
