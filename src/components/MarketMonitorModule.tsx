...
const PriceRange = React.memo(({ low, high, last, instId }: { low?: number; high?: number; last?: number; instId: string }) => {
...
export default React.memo(function MarketMonitorModule({ onJumpToDIY: _onJumpToDIY }: MarketMonitorModuleProps) {
  const { t } = useTranslation();
