...
import { buildMarginDescSegments } from '../lib/configDesc.ts';
import type { MarginConfigItem } from '../types/configItems.ts';
import { getPaymentOptions, getOkxDestOptions, getBinanceDestOptions } from '../constants/marginTransferOptions.ts';
