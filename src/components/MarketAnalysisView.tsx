...
interface MarketAnalysisViewProps {
  ...
  historyPosHasMore?: boolean;
  historyPosLoadingMore?: boolean;
  onLoadMoreHistoryPositions?: () => void;
...
export const MarketAnalysisView: React.FC<MarketAnalysisViewProps> = memo(({
  ...
  historyPositions,
  historyPosHasMore,
  historyPosLoadingMore,
  onLoadMoreHistoryPositions,
      ...
      >
        ...
        <div className="bg-surface-2 border border-border-default rounded-2xl overflow-hidden flex flex-col mt-0">
          <BottomDataPanel
            ...
            historyOrders={historyOrders}
            historyPositions={historyPositions}
            historyPosHasMore={historyPosHasMore}
            historyPosLoadingMore={historyPosLoadingMore}
            onLoadMoreHistoryPositions={onLoadMoreHistoryPositions}
          />
        </div>
      </DraggableSplitter>
    </div>
